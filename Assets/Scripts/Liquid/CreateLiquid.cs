...
namespace Charly.Liquid
{
    public class CreateLiquid : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            _liquidOutputTextureColor =
                new RenderTexture(ScreenResolution.x, ScreenResolution.y, 0, GraphicsFormat.R32G32B32A32_SFloat);
            _liquidOutputTextureColor.enableRandomWrite = true;
            _liquidOutputTextureColor.filterMode = FilterMode.Point;

            _liquidOutputTextureSpecial =
                new RenderTexture(ScreenResolution.x, ScreenResolution.y, 0, GraphicsFormat.R32G32B32A32_SFloat);
        ...
        void Update()
        {
            ...
            ComputeShader.SetVector("ScreenGrabDimensions",
                new Vector4(_cameraTargetRT.width, _cameraTargetRT.height, 0, 0));
